    ...
    return (
        <section className="relative bg-[#050505] text-[#F2F2F2] py-10 md:py-0 px-6 md:px-[8%] my-32 lg:my-4">
            <div className="max-w-1600px mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                <div className="relative h-[50vh] lg:h-[70vh] w-full transition-all duration-1000 group bg-[#0a0a0a] overflow-hidden rounded-sm">
                ...
                <div className="flex flex-col gap-12 lg:pl-16">
                    ...
                    {/* FIX APPLICATO QUI: 
                        1. 'grid-cols-1' su mobile (impila i dati per dare spazio) 
                        2. 'sm:grid-cols-2' dai 640px in su
                        3. 'break-all' sul paragrafo contatti per sicurezza estrema 
                    */}
